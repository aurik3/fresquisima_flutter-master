...
const MaterialColor white = const MaterialColor(
  0xFFFFFFFF,
  const <int, Color>{
    50: const Color(0xFF222226),
    100: const Color(0xF222226),
    200: const Color(0xF222226),
    300: const Color(0xF222226),
    400: const Color(0xF222226),
    500: const Color(0xF222226),
    600: const Color(0xF222226),
    700: const Color(0xF222226),
    800: const Color(0xF222226),
    900: const Color(0xF222226),
  },
);
...
//    primarySwatch: white,
    ...
    indicatorColor: Color(0xFF4a494e),
    toggleableActiveColor: AppColors.secondaryColor,
    splashColor: Colors.white24,
    splashFactory: InkRipple.splashFactory,
    accentColor: secondaryColor,
    canvasColor: white,
    bottomAppBarColor: Color(0xFF4a494e),
